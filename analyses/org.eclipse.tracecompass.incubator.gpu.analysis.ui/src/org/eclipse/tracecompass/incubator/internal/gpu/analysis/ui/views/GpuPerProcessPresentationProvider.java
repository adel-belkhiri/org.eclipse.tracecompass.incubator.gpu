 ...
 *
 */
public class GpuPerProcessPresentationProvider extends TimeGraphPresentationProvider {
     ...
     * Default constructor
     */
    public GpuPerProcessPresentationProvider() {
        super();
    }
...
/*
    ...
    public void postDrawEvent(ITimeEvent event, Rectangle bounds, GC gc) {
        ...
        GPUControlFlowEntry entry = (GPUControlFlowEntry) event.getEntry();
                    ...
                    if (xForEndTime > bounds.x) {
                        ...
                        if (width > 50) {
                            if (! currentRequestSeqno.equals(lastRequestSeqno)) {
                                ...
                                int drawn = Utils.drawText(gc, currentRequestSeqno, x + 1, bounds.y - 2, width,  20 , true, true);
                                if (drawn > 0) {
