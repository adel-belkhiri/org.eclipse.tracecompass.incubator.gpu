 ...
 *
 */
public class GpuRequestsEntry extends TimeGraphEntry implements Comparable<ITimeGraphEntry> {
    /** Type of resource */
     ...
     */
    public GpuRequestsEntry(int quark, @NonNull ITmfTrace trace, String name,
     ...
     *            The id of this entry
     */
    public GpuRequestsEntry(@NonNull ITmfTrace trace, String name,
     ...
     *            The id of this entry
     */
    public GpuRequestsEntry(int quark, @NonNull ITmfTrace trace, long startTime, long endTime, Type type, int id) {
    ...
    public int compareTo(ITimeGraphEntry other) {
        if (!(other instanceof GpuRequestsEntry)) {
            /* Should not happen, but if it does, put those entries at the end */
            return -1;
        }
        GpuRequestsEntry o = (GpuRequestsEntry) other;
