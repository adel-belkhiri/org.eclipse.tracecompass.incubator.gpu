...
package org.eclipse.tracecompass.incubator.network.core.tests;
...
import org.eclipse.tracecompass.incubator.internal.network.core.Activator;
...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.network.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.network.core", instance.getPluginId());
    }
